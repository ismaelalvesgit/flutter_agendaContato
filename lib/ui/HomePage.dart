...
import 'package:app6/ui/contact_page.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';

enum OrderOption{ ordeaz, ordeza }
...
class _HomePageState extends State<HomePage> {
        ...
        actions: <Widget>[
          PopupMenuButton<OrderOption>(itemBuilder: (context)=> <PopupMenuEntry<OrderOption>>[
            const PopupMenuItem <OrderOption>(
              ...
              value: OrderOption.ordeaz,
            ),
            const PopupMenuItem <OrderOption>(
              child: Text("Ordenar Z-A"),
              value: OrderOption.ordeza,
            ),
          ],
  ...
  void _showContactsPage({Contact contact}) async {
  ...
  void _orderList(OrderOption result){
    switch(result){
      case OrderOption.ordeaz:
        contacts.sort((a, b){
          return a.name.toLowerCase().compareTo(b.name.toLowerCase());
        });
        break;
      case OrderOption.ordeza:
        contacts.sort((a, b){
